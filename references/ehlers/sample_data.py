"""
sample_data.py – Data helpers for Ehlers DSP chapter scripts.
"""
...
_env_tickers = os.environ.get("EHLERS_TICKERS")
SYMBOLS = [t.strip() for t in _env_tickers.split(",") if t.strip()] if _env_tickers else ["MSFT", "GOOG", "NVDA", "AMD"]
DEFAULT_START = os.environ.get("EHLERS_DATE_START", "2020-01-01")
DEFAULT_END = os.environ.get("EHLERS_DATE_END", "2024-12-31")
