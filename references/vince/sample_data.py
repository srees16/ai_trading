"""
sample_data.py – Data helpers for Vince Risk Lab chapter scripts.
"""
...
_env_tickers = os.environ.get("VINCE_TICKERS")
SYMBOLS = [t.strip() for t in _env_tickers.split(",") if t.strip()] if _env_tickers else ["MSFT", "GOOG", "NVDA", "AMD"]
DEFAULT_START = os.environ.get("VINCE_DATE_START", "2020-01-01")
DEFAULT_END = os.environ.get("VINCE_DATE_END", "2024-12-31")
