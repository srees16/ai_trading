...
Create a `.env` file in the `centurion_core/` directory (or set the variables inline). Replace the placeholder values below with your own credentials.
