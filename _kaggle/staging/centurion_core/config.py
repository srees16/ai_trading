...
class Config:
    ...
    PIT_UNIVERSE_ENABLED: bool = False         # R24v5: OFF by default (R21A never used this; loads 697 stocks)
    ...
    CARVER_INERTIA_THRESHOLD: float = 0.20  # R24: ↓ from 25% — cost-aware inertia handles churn
    ...
    NSE_UNIVERSE_TIER: str = "DEFAULT"  # R24v5: Match R21A (~95 NIFTY50+NEXT50 stocks)
