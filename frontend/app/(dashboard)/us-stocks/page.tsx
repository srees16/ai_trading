    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="content-panel p-4 space-y-4 min-w-0 overflow-hidden">
          <h3 className="text-sm font-semibold">US Stocks Analysis</h3>
          <TickerInput
            defaultTickers={DEFAULT_US_TICKERS}
            ...
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="content-panel p-4">
                  <DecisionPieChart signals={signals} />
                </div>
                <div className="content-panel p-4">
                  <SentimentBarChart signals={signals} />
                </div>
                <div className="content-panel p-4">
                  <ScoreScatterChart signals={signals} />
                </div>
              </div>
